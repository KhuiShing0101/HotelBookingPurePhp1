...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="<?= $base_url ?>assets/backend/css/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="<?= $base_url ?>assets/backend/css/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <!-- iCheck -->
